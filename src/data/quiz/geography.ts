...
export const geographyQuestions: QuizQuestion[] = [
  {
    question: "ما هي الدولة الخليجية التي تمتلك حدوداً برية مع دولة واحدة فقط؟",
    answer: "قطر",
    options: ["الكويت", "قطر", "البحرين", "الإمارات"],
    },
    {
    question: "ما هي الدولة الأفريقية الوحيدة التي تمتلك سواحل على كل من البحر الأبيض المتوسط والمحيط الأطلسي؟",
    answer: "المغرب",
    options: ["مصر", "الجزائر", "الموريتانيا", "المغرب"],
    },
    {
    question: "في أي دولة يقع المقر الرئيسي لمنظمة الأمم المتحدة؟",
    answer: "الولايات المتحدة الأمريكية",
    options: ["سويسرا", "المملكة المتحدة", "الولايات المتحدة الأمريكية", "النمسا"],
    },
    {
    question: "ما هي الدولة الأفريقية التي تُعرف بلقب 'بلاد المليون ونصف المليون شهيد'؟",
    answer: "الجزائر",
    options: ["السودان", "الجزائر", "إثيوبيا", "جنوب أفريقيا"],
    },
    {
  ...
  {
    question: "ما هو المسطح المائي شديد الملوحة الذي تنعدم فيه الحياة البحرية تقريبًا؟",
    answer: "البحر الميت",
  ...
  {
    question: "ما هي الدولة التي تتوزع أراضيها جغرافياً بين شبه جزيرة الأناضول في قارة آسيا، ومنطقة تراقيا الشرقية في قارة أوروبا؟",
    answer: "تركيا",
    options: ["تركيا", "قبرص", "أرمينيا", "جورجيا"],
  },
  {
  ...
  {
    question: "ما هي الدولة الآسيوية التي تمتلك حدوداً برية مع 14 دولة؟",
    answer: "الصين",

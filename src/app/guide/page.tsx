...
const games = [
  ...
  how: [
    "الفريق الأول يبدأ ويكتب كلمة",
    "بعد كل محاولة تظهر ألوان تساعدكم",
    "الأخضر يعني الحرف صح وبمكانه الصح",
    "الأصفر يعني الحرف موجود لكن بمكان ثاني",
    "الرمادي يعني الحرف مو موجود",
    "بعد كل محاولة ينتقل الدور للفريق الثاني",
    "الفريق اللي يجيب الكلمة الصح يفوز",
  ],

  example:
    "مثال: إذا كانت الكلمة (تفاح) وخمنت (تمور) بتشوف وش صح ووش غلط",
},
